...
do 
    python3 $SCRIPTSDIR/state_cov_run.py -i $WORKDIR/$runs/in-tls-composed -s SVRM -r $runs -o $OUTDIR
    python3 $SCRIPTSDIR/state_cov_run.py -i $WORKDIR/$runs/in-tls-origin -s Manual -r $runs -o $OUTDIR
